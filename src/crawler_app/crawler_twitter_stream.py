...
if __name__ == '__main__':
	...
	#
	if len(sys.argv) < 2:
		print 'Usage: crawl_twitter_stream.py <config file>\n'
		sys.stdout.flush()
		sys.exit(1)
	...
	try :
		...
		dictCrawlSpec = dictConfig['crawl_spec_stream']
		...
		# init source
		# query spec: https://developer.twitter.com/en/docs/tweets/filter-realtime/api-reference/post-statuses-filter.html
		#             https://developer.twitter.com/en/docs/tweets/filter-realtime/guides/basic-stream-parameters
		# user ID from screenname: https://tweeterid.com/
		sourceObj = factoryObj.get_source( source_type = 'twitter_stream' )
		...
		logger.exception('twitter_stream main() exception')
